...
public class pc {
    ...
    public static void main(String[] args) {
        //抓包token
        String zsxq_access_token ="D621F6F8-E5B9-242A-02B2-27EC3B96073E_610B63E6232A4560";
        //圈子ID
        String groupID = "51284855218444";
        //保存路径
        String path = "/Users/tao/IdeaProjects/爬虫/大余";

        //获取文件id
        List<String> idList = getFileIdList(zsxq_access_token, groupID, "");
        //下载文件

        idList.parallelStream().forEach(fileID -> downFile(zsxq_access_token,fileID,path));
